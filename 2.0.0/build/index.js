...
//TODO : 扔了cordX这个属性
// http://a.tbcdn.cn/s/kissy/kg/drawingPad/1.0/
KISSY.add('kg/drawingPad/2.0.0/index',function (S, Node,Dom,Base,JSON,Imgproxy) {
    var CLASS_INTERACT  = "_drawingPad_interact";// var FLASHCANVAS_PKG = "kg/drawingPad/1.0/flashCanvas";
    ...
    function invokeFlashCanvas(){
        window.FlashCanvasOptions = {
            swfPath: "http://a.tbcdn.cn/s/kissy/kg/drawingPad/1.0/",  //modify to CDN
            usePolicyFile:true,
         ...
         * Copyright (c) 2009-2.0.01 Shinya Muramatsu
         */
...
}, {requires:['node','dom', 'base','json','kg/imgProxy/1.0/index']});

...
(c) 2009-2.0.02 Stuart Knightley <stuart [at] stuartk.com>
...
JSZip.prototype = (function () {
   ...
   var generateZipParts = function(name, file, compressedObject, offset) {
      ...
      // date
      // @see http://www.delorie.com/djgpp/doc/rbinter/it/52.0.03.html
   ...
   return {
      ...
      crc32 : function crc32(input, crc) {
         ...
         var table = [
            ...
            0x4DB2.0.058, 0x3AB551CE, 0xA3BC0074, 0xD4BB30E2,
            0x4ADFA541, 0x3DD895D7, 0xA4D1C46D, 0xD3D6F4FB,
            0x4369E96A, 0x346ED9FC, 0xAD678846, 0xDA60B8D0,
            0x44042D73, 0x33031DE5, 0xAA0A4C5F, 0xDD0D7CC9,
            0x5005713C, 0x2702.0.0AA, 0xBE0B1010, 0xC90C2086,
            0x5768B525, 0x206F85B3, 0xB966D409, 0xCE61E49F,
            0x5EDEF90E, 0x29D9C998, 0xB0D09822, 0xC7D7A8B4,
            0x59B33D17, 0x2EB40D81, 0xB7BD5C3B, 0xC0BA6CAD,
            0xEDB88320, 0x9ABFB3B6, 0x03B6E20C, 0x74B1D29A,
            0xEAD54739, 0x9DD277AF, 0x04DB2.0.05, 0x73DC1683,
      ...
      // Inspired by http://my.opera.com/GreyWyvern/blog/show.dml/172.0.065
      clone : function() {
